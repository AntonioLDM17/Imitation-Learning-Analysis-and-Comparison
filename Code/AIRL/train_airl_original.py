...
if __name__ == "__main__":
    print("Example usage: python train_airl.py --env cartpole --timesteps 2_000_000 --seed 44")
    print("Example usage: python train_airl.py --env halfcheetah --timesteps 2_000_000 --seed 44")
