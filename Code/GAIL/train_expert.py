...
def main():
    parser = argparse.ArgumentParser(description="Train an expert using a selectable policy (ppo, trpo, sac)")
    ...
    # Determine the environment name based on the argument
    ...
    # Check that SAC is only used for continuous action environments
